<template>
  <div class="r-pagination-component">
    <!--上一页-->
    <div class="prev mr-4" v-if="mycurrent > 1" @click="changePager(mycurrent - 1)">上一页</div>
    <div class="disable mr-4" v-else>上一页</div>
    ...
    <!--下一页-->
    <div class="next ml-4 mr-2" v-if="mycurrent < pager.pageCount" @click="changePager(mycurrent + 1)">下一页</div>

    <div class="disable ml-4 mr-2" v-else>下一页</div>
    <!--页码-->
    <div class="jump-page">
      <p @click="jumpageDown">跳转</p>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const jumpageDown = () => {
      ...
      changePager(parseInt(userJumppage.value))
    }
    return {
      pager,
      mycurrent,
