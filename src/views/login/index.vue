    ...
    <div class="login-left">
      ...
      <div class="login-slogan-area">
        <div class="inner-slogan">
          ...
          <div class="line-two">美食天下你的健康饮食助手！</div>
        </div>
      </div>
    </div>
    <!--右侧区域-->
      ...
      <div class="login-inner-form">
        ...
        <Form class="form-area" ref="formCom" :validation-schema="loginSchema" autocomplete="off" v-slot="{ errors }">
          ...
          <div class="password-area">
            <Field :type="!showpwd ? 'password' : 'text'" placeholder="请输入密码" v-model="formdata.password" name="password">
            </Field>
            <!--是否查看密码-->
          ...
          <div class="login-button">
            <rbutton :radius="40" @click="login" :disabled="loginloading" :loading="loginloading" loadingText="登录中...">登录
            </rbutton>
          </div>
          <!--是否同意协议-->
          <div class="agreement">
...
export default {
  ...
  setup() {
    ...
    const login = async () => {
      ...
      try {
        // 调用登录接口
        await store.dispatch('user/getUserLogin', userinfo)
